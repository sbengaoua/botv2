...
namespace QnAMakerActiveLearningBot
{
    ...
    public class QnAMakerActiveLearningBot : IBot
    {
        ...
        private const string WelcomeText = "I'm the Moët Hennessy security chatbot, I'm here to help you to answer to every security questions. Please ask me something to start the chat.";
